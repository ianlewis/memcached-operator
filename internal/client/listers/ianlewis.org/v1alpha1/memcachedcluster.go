...
// MemcachedClusterLister helps list MemcachedClusters.
type MemcachedClusterLister interface {
	...
	MemcachedClusterListerExpansion
}

// memcachedClusterLister implements the MemcachedClusterLister interface.
...
type MemcachedClusterNamespaceLister interface {
	...
	MemcachedClusterNamespaceListerExpansion
}
